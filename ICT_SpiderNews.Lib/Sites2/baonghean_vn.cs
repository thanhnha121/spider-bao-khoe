...
{
    public class baonghean_vn : ISite
    {       
        public IEnumerable<LinkInfo> GetLinkElements(string channelUrl)
        {
            ...
            var links = Utilities._GetNodes(doc, "//a[@class=\"title Article\"]");
            if (links != null)
            {
        ...
        public ArticleElementInfo GetArticleElement(string articleUrl)
        {
            ...
            //excerpt
            articleElement.Excerpt = Utilities._GetNode(doc, "//div[@id=\"content\"]", ".//strong");
            //author
